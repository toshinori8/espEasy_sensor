  ...
  <body>
    ...
    <style type="text/css">
      ...
      #sha_button_list ul li.on span {
        ...
        background-color: rgba(49, 69, 106, 0);
        box-shadow: 3px 3px 5px -1px rgba(0, 0, 0, 0.15),
          -6px -6px 10px -1px rgba(255, 255, 255, 0.7),
          0px -4px 5px rgba(0, 13, 0, 0.3);
      }
      padding: 0px 0px 0px;
      ...
      <div id="sha_app" class="row">
        ...
        <section id="sha_header_bar" class="col-12">
          <div class="row">
            ...
            <div class="col-12">
              ...
              <span class="heading" contenteditable="true">Kuchnia</span>
            </div>
          </div>
        </section>
        ...
        <section id="sha_footer" class="col-12">
          <div class="row">
            <div class="col-4">
              <div>
                <span class="footer_title text-left"> Tryb parowania</span>
